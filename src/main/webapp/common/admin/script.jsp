...
<!-- Page level plugins -->
<script src="template/loginAdmin/vendor/chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="template/loginAdmin/js/demo/chart-area-demo.js"></script>
<script src="template/loginAdmin/js/demo/chart-pie-demo.js"></script>