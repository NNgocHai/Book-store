...
<div id="wrapper">
    <jsp:include page = "/common/shipper/menu.jsp" flush = "true" />
            ...
            <ul class="navbar-nav align-items-center right-nav-link">
              ...
              <span class="user-profile"><img src="${pageContext.request.contextPath}/template/admin/images/avatar-admin.png" class="img-circle"
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href=" ">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <b> Shipper:  <%=session.getAttribute("user") %></b>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="dropdown-item"><i class="icon-power mr-2"></i><a href=${pageContext.request.contextPath}/shipper/logout> Đăng xuất</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
